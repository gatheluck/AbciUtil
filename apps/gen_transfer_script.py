        ...
        with open(v['config']) as f:
            ...
            for unfreeze_level in unfreeze_levels:
                for augmentation in augmentations:
                    ...
                    # cmd for test
                    cmds.append('python test.py tester=acc arch={arch} dataset={dataset} batch_size={batch_size}'.format(arch=conf['arch'], dataset=target_dataset, batch_size=int(batch_size / 2.0)))
                    ...
                    cmds.append('python test.py tester=spacial arch={arch} dataset={dataset} batch_size={batch_size}'.format(arch=conf['arch'], dataset=target_dataset, batch_size=int(batch_size / 2.0)))
                    ...
                    cmds.append('python test.py tester=fourier arch={arch} dataset={dataset} tester.batch_size={batch_size}'.format(arch=conf['arch'], dataset=target_dataset, batch_size=int(batch_size / 2.0)))
