        ...
        with open(v['config']) as f:
            ...
            for unfreeze_level in unfreeze_levels:
                for augmentation in augmentations:
                    ...
                    cmds.append('python test.py tester=fourier arch={arch} dataset={dataset} tester.batch_size={batch_size}'.format(arch=conf['arch'], dataset=target_dataset, batch_size=batch_size))
