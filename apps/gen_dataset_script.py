    ...
    for metric in metrics:
        for norm_type in norm_types:
            for num_basis, image_size in zip(num_basies, image_sizes):
                ...
                datasetname = '_'.join(['fbdb', metrics, norm_type, num_image_per_class, num_basis, image_size])
...
if __name__ == '__main__':
    ...
    generate_datset_script(metrics=opt.metrics, norm_types=opt.norm_type, num_image_per_class=num_image_per_class, num_basies=opt.num_basies, image_sizes=opt.image_sizes, val_ratio=opt.val_ratio, log_dir=opt.log_dir)
